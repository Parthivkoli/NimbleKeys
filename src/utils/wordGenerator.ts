const commonWords = [
  ...
  'after', 'words', 'first', 'where', 'only', 'new', 'work', 'part', 'take', 'get',
  ...
  'wonder', 'laugh', 'thousands', 'ago', 'ran', 'check', 'game', 'shape', 'equate', 'hot',
  ...
  'cloud', 'surprise', 'quiet', 'stone', 'tiny', 'climb', 'bad', 'oil', 'blood', 'touch',
  'grew', 'cent', 'mix', 'team', 'wire', 'cost', 'lost', 'brown', 'wear', 'garden',
  ...
  'agree', 'thus', 'capital', 'won', 'chair', 'danger', 'fruit', 'rich', 'thick', 'soldier',
